...
import com.example.spj.p2p.utils.pay.PayKeys;
import com.example.spj.p2p.utils.pay.PayResult;
import com.example.spj.p2p.utils.pay.SignUtils;
...
public class ChongZhiActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        chongzhiEt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                String money = chongzhiEt.getText().toString().trim();
    ...
    @OnClick({R.id.iv_top_back, R.id.chongzhi_btn})
